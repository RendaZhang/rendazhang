import{c as a}from"./certifications.fa7edf7a.BW8oITAp.js";import{w as o,z as s,t as i,c as r,m as c,j as t}from"./ThemeProvider.Bev9uskO.js";import"./index.CVOHBThD.js";(function(){var n=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{};n.SENTRY_RELEASE={id:"14ba032f3980a4b35df923fc61ae12d92d1139d5"}})();try{(function(){var n=typeof window<"u"?window:typeof global<"u"?global:typeof globalThis<"u"?globalThis:typeof self<"u"?self:{},e=new n.Error().stack;e&&(n._sentryDebugIds=n._sentryDebugIds||{},n._sentryDebugIds[e]="8f1afaea-fd54-49cc-bdfa-d88be714d630",n._sentryDebugIdIdentifier="sentry-dbid-8f1afaea-fd54-49cc-bdfa-d88be714d630")})()}catch{}const d="/_astro/Resume_RendaZhang.DCUZYFnc.pdf",l="/_astro/%E4%B8%AA%E4%BA%BA%E7%AE%80%E5%8E%86_%E5%BC%A0%E4%BA%BA%E5%A4%A7.BuAZwOrY.pdf",E="/_astro/qrcode-wechat-medium-square-258x258.Ds94gEha.jpg",h=`<!-- START doctoc generated TOC please keep comment here to allow auto update -->
...
> 说明项目的 CSS 架构与构建流程，展示 \`postcss-import\` 如何在编译阶段内联 \`theme.css\` 引用的核心与工具样式以减少运行时请求，详见：📄 [样式说明](https://github.com/RendaZhang/rendazhang/blob/master/docs/STYLE_GUIDE.md#%E6%A0%B7%E5%BC%8F%E8%AF%B4%E6%98%8E)。
...
`,g=`<!-- START doctoc generated TOC please keep comment here to allow auto update -->
<!-- DON'T EDIT THIS SECTION, INSTEAD RE-RUN doctoc TO UPDATE -->
...
`,A="/deepseek_chat",B="/certifications",b="/docs",f="/login",R="/register",y="/",v={README_ZH:h,README_EN:g},C={CHAT_WIDGET:a},S={WECHAT_QR:E,RESUME_EN:d,RESUME_ZH:l},T={WECHAT:o,ZHIHU:s,TOUTIAO:i,CSDN:r,MEDIUM:c},_="Resume_RendaZhang_20250622.pdf",w="个人简历_张人大_20250622.pdf";function I({zhContent:n,enContent:e}){return t.jsxs(t.Fragment,{children:[t.jsx("span",{className:"lang-zh",children:n}),t.jsx("span",{className:"lang-en",children:e})]})}export{A as C,b as D,y as H,S as I,I as L,w as R,C as S,B as a,f as b,T as c,_ as d,R as e,v as f};
//# sourceMappingURL=LocalizedSection.COHxOrxE.js.map
