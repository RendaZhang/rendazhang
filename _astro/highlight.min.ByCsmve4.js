/*!
  Highlight.js v11.11.1 (git: 1f6d0fbef1)
...
})(e);return"("+(n.capture?"":"?:")+e.map(e=>c(e)).join("|")+")"}function p(e){
...
const l=Object.create(null);function c(e,n){return e.keywords[n]}function d(){
...
;const a=k.case_insensitive?n[0].toLowerCase():n[0],i=c(M,a);if(i){const[e,r]=i
;if(S.addText(t),
t="",l[a]=(l[a]||0)+1,l[a]<=7&&(T+=r),e.startsWith("_"))t+=n[0];else{
