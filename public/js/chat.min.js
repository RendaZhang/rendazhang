document.addEventListener("DOMContentLoaded", function() {
    ...
    const ENDPOINT_CHAT = (window.config && window.config.LEGACY_CHAT_ENDPOINT) || `${API_BASE_URL}/chat`;
    const TYPING_INTERVAL = (window.config && window.config.TYPING_INTERVAL) || 30;
